...
export function MeasurementForm({ categoryId, categoryName, onConfirm, onCancel }: MeasurementFormProps) {
            ...
            <AnimatePresence mode="wait">
                    ...
                    >
                        ...
                        >
                            <div className="flex items-start gap-3">
                                ...
                                <div className="flex-1">
                                    <h3 className="font-semibold text-foreground text-sm">Use Saved Measurements</h3>
                        ...
                        >
                            <div className="flex items-start gap-3">
                                ...
                                <div className="flex-1">
                                    <h3 className="font-semibold text-foreground text-sm">Enter New Measurements</h3>
                                    <p className="text-xs text-muted-foreground mt-0.5">
                ...
                {selectionMode === "saved" && savedMeasurements && (
                    ...
                    >
                        ...
                        <div className="bg-muted/50 rounded-xl p-4">
                            <h4 className="font-medium mb-3 text-xs">Your Saved Measurements</h4>
                            <div className="grid grid-cols-2 gap-2 max-h-[200px] overflow-y-auto p-1">
                                {config.fields.map(field => (
                                    <div key={field.id} className="flex justify-between text-[11px] py-1.5 px-2 rounded bg-background border">
                ...
                {selectionMode === "new" && (
                    ...
                    >
                        ...
                        <div className="flex items-center gap-2 p-2 bg-muted/50 rounded-lg text-[10px]">
                        ...
                        <div className="grid grid-cols-2 gap-2 max-h-[240px] overflow-y-auto pr-1">
                            {config.fields.map(field => (
                                <div key={field.id} className="space-y-1">
                                    <Label htmlFor={field.key} className="text-[9px] font-semibold uppercase tracking-wider text-muted-foreground">
                                        {field.name}
                                    </Label>
                                    <div className="relative">
                                        <Input
                                            ...
                                            className="pr-6 h-8 text-xs focus-visible:ring-amber-500"
                                        />
                        ...
                        <div className="flex gap-2 pt-2">
                            ...
                            >
                                {filledCount < Math.min(4, totalFields)
                                    ? `Need ${Math.min(4, totalFields) - filledCount}`
                                    : "Confirm"
                                }
                            </Button>
                        </div>
