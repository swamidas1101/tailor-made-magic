...
import { Scissors, Lock, Mail, User, ArrowRight, Eye, EyeOff } from "lucide-react";
      ...
      <div className="min-h-[80vh] flex items-center justify-center py-12 px-4">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-display font-bold">Welcome to Tailo</h1>
            <p className="text-muted-foreground mt-2">Sign in to access your orders and wishlist</p>
          </div>
          ...
          <p className="text-center mt-6 text-sm text-muted-foreground">
            Are you a tailor or admin?{" "}
            <Link to="/login" className="text-primary hover:underline">Business Login →</Link>
          </p>
        </div>
      </div>
    </Layout>
