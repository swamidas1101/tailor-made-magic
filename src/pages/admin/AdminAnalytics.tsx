      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 border-b border-border/40 pb-8">
        <div>
          <div className="flex items-center gap-2 text-amber-600 mb-2">
            ...
            <span className="text-xs font-bold uppercase tracking-widest">Platform Intelligence</span>
          </div>
          <h1 className="text-3xl lg:text-4xl font-display font-bold text-foreground tracking-tight">Analytics Dashboard</h1>
          <p className="text-muted-foreground text-sm mt-2 max-w-xl leading-relaxed">
            Comprehensive overview of platform performance, revenue streams, and user engagement metrics.
          </p>
        </div>
        <div className="flex items-center gap-3 bg-muted/10 p-1.5 rounded-xl border border-border/40">
          ...
          <Button variant="ghost" size="icon" className="h-9 w-9 text-muted-foreground hover:text-amber-600">
