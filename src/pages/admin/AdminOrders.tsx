    ...
    <div className="p-4 lg:p-10 space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700 bg-white min-h-screen">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 border-b border-border/40 pb-6">
        <div>
          ...
          <h1 className="text-2xl lg:text-3xl font-display font-bold text-foreground">Order Management</h1>
          <p className="text-muted-foreground text-sm mt-1">Track and manage customer orders and shipments</p>
        </div>
        <div className="flex items-center gap-2">
          <Button variant="outline" size="sm" className="h-9 text-xs font-bold uppercase tracking-wider">
            <Download className="w-3.5 h-3.5 mr-2" /> Export
          </Button>
          <Button onClick={fetchOrders} size="sm" className="h-9 bg-amber-600 hover:bg-amber-700 text-xs font-bold uppercase tracking-wider">
            Refresh
          </Button>
        </div>
      </div>
