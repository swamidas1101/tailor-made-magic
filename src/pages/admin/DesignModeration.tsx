...
export default function DesignModeration() {
  ...
  return (
    <div className="p-4 lg:p-10 space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700 bg-white min-h-screen">
      {/* Header */}
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-border/40 pb-6">
        <div>
          ...
          <h1 className="text-2xl lg:text-3xl font-display font-bold text-foreground">Design Moderation</h1>
          <p className="text-muted-foreground text-sm mt-1">Review and approve artisan design submissions</p>
        </div>
        <div className="flex gap-2">
          <Button variant="outline" size="sm" className="h-9 text-xs font-bold uppercase tracking-wider">
            Guidelines
          </Button>
          <Button onClick={fetchDesigns} size="sm" className="h-9 bg-muted text-foreground hover:bg-muted/80 text-xs font-bold uppercase tracking-wider">
            Refresh
          </Button>
        </div>
      </div>
              ...
              <div className="w-full md:w-1/2 flex flex-col h-full bg-white min-h-0">
                ...
                <div className="flex-1 overflow-y-auto p-6 md:p-8 space-y-6">
                  <div>
                    ...
                    <h2 className="text-2xl md:text-3xl font-display font-bold text-foreground tracking-tight leading-tight">{selectedDesign.name}</h2>
