...
export default function TailorEarnings() {
  ...
  return (
    <div className="p-4 lg:p-8 space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
      {/* Header */}
      <div className="flex flex-col gap-4">
        <div className="flex justify-between items-start">
          <div>
            <h1 className="text-2xl lg:text-3xl font-display font-bold text-foreground">Earnings Center</h1>
            <p className="text-muted-foreground text-sm mt-1">Real-time revenue tracking and performance insights</p>
          </div>
          <div className="hidden sm:flex gap-2">
            <Button variant="outline" size="sm" className="h-9 border-border/50 shadow-soft">
              <Download className="w-4 h-4 mr-2" /> Export
            </Button>
            <Button size="sm" className="h-9 bg-primary shadow-lg shadow-primary/20 font-bold">
          ...
          {periods.map((p) => (
            <Button
              ...
              className={cn(
                ...
                period === p.id ? "bg-amber-600 shadow-md shadow-amber-900/20" : "bg-card border-border/50"
              )}
